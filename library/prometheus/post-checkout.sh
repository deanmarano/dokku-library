...
data_dir="/var/lib/dokku/data/storage/${app_name}-data"
...
chown -R 65534:65534 "$config_dir"
...
# Auto-generated by dokku library:checkout prometheus
*/2 * * * * root ${script_dir}/generate-targets.sh ${app_name} >/dev/null 2>&1
CRON
chmod 644 /etc/cron.d/dokku-prometheus-discovery

# Run target generation once immediately
echo "       Running initial target discovery"
"$script_dir/generate-targets.sh" "$app_name"
